...
func (s *defaultOpenAIAccountScheduler) selectBySessionHash(
	...
	if reason, errorRate, ttft, shouldEscape := s.shouldEscapeStickyAccount(accountID, escapeCfg); shouldEscape && !IsStrictSessionHash(sessionHash) {
	...
	if s.service.concurrencyService != nil {
		if escapeCfg.enabled && !IsStrictSessionHash(sessionHash) && acquireErr == nil && result != nil && !result.Acquired {

...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/chenzetong/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="chenzetong/sub2api"
...
Documentation=https://github.com/chenzetong/sub2api
